...
const ParisPage = () => {
  ...
  const faqs = [
    ...
    { question: "Combien coûte la réparation d'un volet roulant à Paris ?", answer: "Le coût dépend du type de panne et des pièces à remplacer. Nous réalisons un diagnostic gratuit et vous remettons un devis détaillé avant toute intervention. Pas de frais de déplacement à Paris. Contactez-nous pour une estimation personnalisée." },
