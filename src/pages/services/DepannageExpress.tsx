    ...
    <main id="main-content" className="relative">
      ...
      <FAQSection
        ...
        faqs={[
          ...
          { q: "Y a-t-il un surcoût pour le dépannage le week-end ?", a: "Un forfait week-end/jour férié peut s'appliquer. Cependant, le diagnostic reste gratuit et le devis est établi avant toute intervention. Aucune surprise." },
