...
const defaultFaqs: FAQItem[] = [
  ...
  { q: "Offrez-vous une garantie sur vos réparations ?", a: "Oui, toutes nos réparations sont garanties 2 ans pièces et main-d'œuvre. Les moteurs neufs bénéficient d'une garantie constructeur de 5 ans. Nous utilisons exclusivement des pièces d'origine ou de qualité équivalente certifiée pour garantir la durabilité de nos interventions." },
];
