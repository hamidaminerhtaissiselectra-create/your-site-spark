...
const defaultFaqs: FAQItem[] = [
  { q: "Combien coûte la réparation d'un volet roulant à Paris ?", a: "Le coût d'une réparation de volet roulant à Paris varie selon le type de panne et les pièces à remplacer. Répar'Action Volets réalise un diagnostic gratuit et vous remet un devis détaillé avant toute intervention — sans surprise ni frais cachés. Contactez-nous pour une estimation personnalisée." },
