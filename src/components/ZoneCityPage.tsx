...
const ZoneCityPage = ({ city }: ZoneCityPageProps) => {
  ...
  const faqs = [
    ...
    city.uniqueFaq,
    { q: `Quel est le coût moyen d'une réparation de volet roulant à ${city.name} ?`, a: `Le coût d'une réparation à ${city.name} varie selon le type de panne et les pièces nécessaires. Le diagnostic est 100% gratuit et sans engagement — nous vous remettons un devis détaillé et personnalisé avant toute intervention. Contactez-nous pour une estimation adaptée à votre situation.` },
